    ...
    <div className="w-full max-w-md animate-fade-in-up">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-slate-muted">
          Create your MICo account and connect with Michigan&apos;s tech scene.
        </p>
      </div>
      ...
      <form action={handleSignup} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            <User className="absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-light" />
            <input
              id="fullName"
              name="fullName"
              type="text"
      ...
      {/* Terms */}
      <p className="mt-4 text-center text-xs text-slate-light leading-relaxed">
